...
const navItems = [
  { label: "Penitip", path: "penitip" },
  { label: "Pesan Diskusi", path: "historydonasi" },
  { label: "Verifikasi Bukti", path: "laporan" },
  { label: "Daftar Claim Merch", path: "dataorgan" },
